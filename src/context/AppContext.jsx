...
export const AppProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      documents: "Documents",
      facultyDocumentPortal: "Faculty Portal · Document Submission",
      uploadTeachingDocs: "Upload Teaching Materials",
      uploadTeachingDocsSub:
        "Submit study guides, slide decks, handouts, and class materials for review before sharing with students.",
      pending: "Pending",
      approved: "Approved",
      needsChanges: "Needs changes",
      dragFilesHere: "Drag files here, or click to browse",
      docUploadHint: "PDF, DOC/DOCX, PPT/PPTX, and image files · multiple files supported",
      readyToSubmit: "Ready to submit",
      files: "files",
      documentTitle: "Document title",
      chooseSubject: "Choose subject",
      removeFile: "Remove file",
      completeEachFile: "Add a title and subject to each file before submitting.",
      addMoreFiles: "Add more files",
      submitForReview: "Submit for review",
      documentSubmitted: "Submitted. The office will review your files shortly.",
      yourSubmissions: "Your submissions",
      noSubmissionsYet: "You have not submitted any documents yet.",
      reviewerNote: "Reviewer note",
      studentDocumentPortal: "Student Portal · Classroom Library",
      classMaterials: "Class Materials",
      classMaterialsSub:
        "Read approved teaching materials from your classes, download files, and keep private study notes.",
      subjects: "Subjects",
      searchDocuments: "Search documents, teachers, or subjects...",
      gridView: "Grid view",
      listView: "List view",
      loadingDocuments: "Loading documents...",
      documentsFailed: "Failed to load student documents.",
      documentPreviewFailed: "Failed to open document preview.",
      documentDownloadFailed: "Failed to download document.",
      noDocumentsFound: "No documents match your search.",
      previewUnavailable: "Preview unavailable",
      previewUnavailableSub: "This file type can still be downloaded for reading in another app.",
      teacher: "Teacher",
      file: "File",
      posted: "Posted",
      read: "Read",
      download: "Download",
      myNotes: "My Notes",
      notePlaceholder: "Write your study notes here...",
      ...
      studentPortalRegistrar: "Registrar / Student Academic Portal",
      studentPortalStudentId: "Student ID",
      studentPortalIssued: "Issued",
      studentPortalStatus: "Status",
      studentPortalPortal: "Portal",
      studentPortalNotIssued: "Not issued",
      studentPortalCurrentGpa: "CURRENT GPA",
      studentPortalAttendance: "ATTENDANCE",
      studentPortalMeanPresence: "Mean Presence",
      studentPortalRecordedAbsences: "Recorded Absences",
      studentPortalSubjectsTracked: "Subjects Tracked",
      studentPortalActiveCheckIn: "Active Check-In",
      studentPortalSessions: "sessions",
      studentPortalCurrentRecord: "Current record",
      studentPortalEnrolledClasses: "Enrolled classes",
      studentPortalLive: "Live",
      studentPortalWaiting: "Waiting",
      studentPortalNoLiveSession: "No live session",
      studentPortalTranscriptBySubject: "Transcript - Attendance by Subject",
      studentPortalSubjects: "subjects",
      studentPortalSubject: "Subject",
      studentPortalTeacher: "Teacher",
      studentPortalRate: "Rate",
      studentPortalGrade: "Grade",
      studentPortalNoSubjectRecords: "No subject records available yet.",
      studentPortalGpa: "Grade Point Average",
      studentPortalAttendanceStanding: "Attendance Standing",
      studentPortalFourScale: "4.0 scale",
      studentPortalLiveRate: "Live rate",
      studentPortalCumulative: "Cumulative",
      studentPortalPresent: "Present",
      studentPortalCredits: "Credits",
      studentPortalTotal: "Total",
      studentPortalRemaining: "Remaining",
      studentPortalPerformanceComparison: "Performance Comparison - Student vs. Class Average",
      studentPortalBySubject: "By Subject",
      studentPortalBySemester: "By Semester",
      studentPortalByYear: "By Year",
      studentPortalClassAverage: "Class Average",
      studentPortalNoData: "No data",
      studentPortalScanAttendance: "Scan Attendance",
      studentPortalScanAttendanceSub: "Open camera check-in for active sessions.",
      studentPortalManualEntry: "Manual Entry",
      studentPortalTypeCode: "Type your student code.",
      studentPortalWaitingTeacher: "Waiting for teacher to start.",
      studentPortalFullHistory: "Full History",
      studentPortalFullHistorySub: "Review every attendance record.",
      studentPortalLiveNow: "Live now",
      studentPortalActiveSession: "Active session",
      studentPortalRoomTbd: "Room TBD",
      studentPortalGeneratedNotice: "Generated for student review - not an official registrar document",
    },
    kh: {
      ...
      documents: "ឯកសារ",
      facultyDocumentPortal: "គណនីសាស្ត្រាចារ្យ · ដាក់ស្នើឯកសារ",
      uploadTeachingDocs: "បង្ហោះឯកសារបង្រៀន",
      uploadTeachingDocsSub:
        "ដាក់ស្នើឯកសារសិក្សា ស្លាយ មេរៀន និងសម្ភារៈថ្នាក់រៀន សម្រាប់ពិនិត្យមុនចែករំលែកទៅនិស្សិត។",
      pending: "កំពុងរង់ចាំ",
      approved: "បានអនុម័ត",
      needsChanges: "ត្រូវកែប្រែ",
      dragFilesHere: "ទម្លាក់ឯកសារនៅទីនេះ ឬចុចដើម្បីជ្រើសរើស",
      docUploadHint: "គាំទ្រ PDF, DOC/DOCX, PPT/PPTX និងរូបភាព · អាចជ្រើសបានច្រើនឯកសារ",
      readyToSubmit: "រួចរាល់សម្រាប់ដាក់ស្នើ",
      files: "ឯកសារ",
      documentTitle: "ចំណងជើងឯកសារ",
      chooseSubject: "ជ្រើសរើសមុខវិជ្ជា",
      removeFile: "លុបឯកសារ",
      completeEachFile: "សូមបញ្ចូលចំណងជើង និងមុខវិជ្ជាសម្រាប់ឯកសារនីមួយៗ មុនដាក់ស្នើ។",
      addMoreFiles: "បន្ថែមឯកសារ",
      submitForReview: "ដាក់ស្នើសម្រាប់ពិនិត្យ",
      documentSubmitted: "បានដាក់ស្នើ។ ការិយាល័យនឹងពិនិត្យឯកសាររបស់អ្នកឆាប់ៗនេះ។",
      yourSubmissions: "ឯកសារដែលបានដាក់ស្នើ",
      noSubmissionsYet: "អ្នកមិនទាន់បានដាក់ស្នើឯកសារណាមួយទេ។",
      reviewerNote: "កំណត់សម្គាល់អ្នកពិនិត្យ",
      studentDocumentPortal: "គណនីនិស្សិត · បណ្ណាល័យថ្នាក់រៀន",
      classMaterials: "សម្ភារៈថ្នាក់រៀន",
      classMaterialsSub:
        "អានឯកសារបង្រៀនដែលបានអនុម័ត ទាញយកឯកសារ និងរក្សាកំណត់ចំណាំសិក្សាផ្ទាល់ខ្លួន។",
      subjects: "មុខវិជ្ជា",
      searchDocuments: "ស្វែងរកឯកសារ គ្រូ ឬមុខវិជ្ជា...",
      gridView: "មើលជាក្រឡា",
      listView: "មើលជាបញ្ជី",
      loadingDocuments: "កំពុងទាញយកឯកសារ...",
      documentsFailed: "បរាជ័យក្នុងការទាញយកឯកសារនិស្សិត។",
      documentPreviewFailed: "បរាជ័យក្នុងការបើកមើលឯកសារ។",
      documentDownloadFailed: "បរាជ័យក្នុងការទាញយកឯកសារ។",
      noDocumentsFound: "មិនមានឯកសារដែលត្រូវនឹងការស្វែងរកទេ។",
      previewUnavailable: "មិនអាចមើលជាមុនបាន",
      previewUnavailableSub: "ប្រភេទឯកសារនេះអាចទាញយកទៅអានក្នុងកម្មវិធីផ្សេងបាន។",
      teacher: "គ្រូ",
      file: "ឯកសារ",
      posted: "បានបង្ហោះ",
      read: "អាន",
      ...
      notePlaceholder: "សរសេរកំណត់ចំណាំសិក្សារបស់អ្នកនៅទីនេះ...",
      attendanceSummarySub:
      ...
      studentPortalRegistrar: "ការិយាល័យចុះបញ្ជី / ផតថលសិក្សានិស្សិត",
      studentPortalStudentId: "លេខសម្គាល់និស្សិត",
      studentPortalIssued: "ចេញផ្សាយ",
      studentPortalStatus: "ស្ថានភាព",
      studentPortalPortal: "ផតថល",
      studentPortalNotIssued: "មិនទាន់ចេញផ្សាយ",
      studentPortalCurrentGpa: "GPA បច្ចុប្បន្ន",
      studentPortalAttendance: "វត្តមាន",
      studentPortalMeanPresence: "វត្តមានមធ្យម",
      studentPortalRecordedAbsences: "អវត្តមានដែលបានកត់ត្រា",
      studentPortalSubjectsTracked: "មុខវិជ្ជាដែលតាមដាន",
      studentPortalActiveCheckIn: "ចុះវត្តមានសកម្ម",
      studentPortalSessions: "វគ្គ",
      studentPortalCurrentRecord: "កំណត់ត្រាបច្ចុប្បន្ន",
      studentPortalEnrolledClasses: "ថ្នាក់ដែលបានចុះឈ្មោះ",
      studentPortalLive: "កំពុងដំណើរការ",
      studentPortalWaiting: "កំពុងរង់ចាំ",
      studentPortalNoLiveSession: "មិនមានវគ្គកំពុងដំណើរការ",
      studentPortalTranscriptBySubject: "ប្រតិចារិក - វត្តមានតាមមុខវិជ្ជា",
      studentPortalSubjects: "មុខវិជ្ជា",
      studentPortalSubject: "មុខវិជ្ជា",
      studentPortalTeacher: "គ្រូ",
      studentPortalRate: "អត្រា",
      studentPortalGrade: "និទ្ទេស",
      studentPortalNoSubjectRecords: "មិនទាន់មានកំណត់ត្រាមុខវិជ្ជាទេ។",
      studentPortalGpa: "មធ្យមភាគពិន្ទុ",
      studentPortalAttendanceStanding: "ស្ថានភាពវត្តមាន",
      studentPortalFourScale: "មាត្រដ្ឋាន 4.0",
      studentPortalLiveRate: "អត្រាបច្ចុប្បន្ន",
      studentPortalCumulative: "សរុបសន្សំ",
      studentPortalPresent: "មានវត្តមាន",
      studentPortalCredits: "ក្រេឌីត",
      studentPortalTotal: "សរុប",
      studentPortalRemaining: "នៅសល់",
      studentPortalPerformanceComparison: "ការប្រៀបធៀបលទ្ធផល - និស្សិត និងមធ្យមភាគថ្នាក់",
      studentPortalBySubject: "តាមមុខវិជ្ជា",
      studentPortalBySemester: "តាមឆមាស",
      studentPortalByYear: "តាមឆ្នាំ",
      studentPortalClassAverage: "មធ្យមភាគថ្នាក់",
      studentPortalNoData: "គ្មានទិន្នន័យ",
      studentPortalScanAttendance: "ស្កេនវត្តមាន",
      studentPortalScanAttendanceSub: "បើកកាមេរ៉ាសម្រាប់ចុះវត្តមានក្នុងវគ្គសកម្ម។",
      studentPortalManualEntry: "បញ្ចូលដោយដៃ",
      studentPortalTypeCode: "បញ្ចូលលេខសម្គាល់និស្សិតរបស់អ្នក។",
      studentPortalWaitingTeacher: "កំពុងរង់ចាំគ្រូចាប់ផ្តើម។",
      studentPortalFullHistory: "ប្រវត្តិពេញលេញ",
      studentPortalFullHistorySub: "ពិនិត្យកំណត់ត្រាវត្តមានទាំងអស់។",
      studentPortalLiveNow: "កំពុងដំណើរការ",
      studentPortalActiveSession: "វគ្គសកម្ម",
      studentPortalRoomTbd: "បន្ទប់មិនទាន់កំណត់",
      studentPortalGeneratedNotice: "បង្កើតសម្រាប់ការពិនិត្យរបស់និស្សិត - មិនមែនជាឯកសារផ្លូវការរបស់ការិយាល័យចុះបញ្ជីទេ",
    },
  };
