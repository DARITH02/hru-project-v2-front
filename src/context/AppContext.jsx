...
export const AppProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      noChatContacts: "No chat contacts are available.",
      noChatMessages: "No messages yet. Send the first message.",
      adminRole: "Admin",
      ...
      typing: "Typing...",
      today: "Today",
      messagePlaceholder: "Message support...",
      ...
      confirmDeleteForMe: "Delete this message from your chat?",
      confirmDeleteForEveryone: "Delete this message for everyone?",
      reactWith: "React with",
      chatYou: "You",
      attachment: "Attachment",
      attachments: "attachments",
      message: "Message",
      dropImage: "Drop image to share",
    ...
    kh: {
      ...
      openChat: "បើកជជែក",
      closeChat: "បិទជជែក",
      chatContacts: "បញ្ជីអ្នកជជែក",
      noChatContacts: "មិនមានអ្នកជជែកទេ។",
      noChatMessages: "មិនទាន់មានសារ។ សូមផ្ញើសារដំបូង។",
      adminRole: "Admin",
      superAdmin: "Super Admin",
      connecting: "កំពុងភ្ជាប់...",
      activeNow: "កំពុងអនឡាញ",
      offline: "ក្រៅបណ្តាញ",
      typing: "កំពុងវាយ...",
      today: "ថ្ងៃនេះ",
      messagePlaceholder: "ផ្ញើសារទៅជំនួយការ...",
      attachImage: "ភ្ជាប់រូបភាព",
      removeImage: "លុបរូបភាព",
      addEmoji: "បន្ថែម emoji",
      sendMessage: "ផ្ញើសារ",
      replyToMessage: "ឆ្លើយតបសារ",
      cancelReply: "បោះបង់ការឆ្លើយតប",
      messageActions: "សកម្មភាពសារ",
      editMessage: "កែសារ",
      ...
      deleteForEveryone: "លុបសម្រាប់គ្រប់គ្នា",
      confirmDeleteForMe: "លុបសារនេះចេញពីការជជែករបស់អ្នកឬ?",
      confirmDeleteForEveryone: "លុបសារនេះសម្រាប់គ្រប់គ្នាឬ?",
      reactWith: "ប្រតិកម្មជាមួយ",
      chatYou: "អ្នក",
      attachment: "ឯកសារភ្ជាប់",
      attachments: "ឯកសារភ្ជាប់",
      message: "សារ",
      dropImage: "ទម្លាក់រូបភាពដើម្បីចែករំលែក",
      closeEmojiPicker: "បិទ emoji picker",
      voiceCall: "ហៅសំឡេង",
      videoCall: "ហៅវីដេអូ",
